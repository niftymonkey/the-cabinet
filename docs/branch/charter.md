...
The grave reads as a grave in the ground, and everything it swallows falls in where the player can see it, the Undertaker included. The branch covers #148 and its sub-issue #106. It is one step with seven slices.
