...
- **Boss score paid beside boss score that survived to the end of the run**, because the floor's first hit bleeds the whole bank and those are two different numbers. The pair is what says whether per hit bought anything over a lump, and it is the evidence under the ruling's own reason.
