...
- `touch.ts`: uncapped drag steering onto the drag target. Steering is all it does: Mark ruled on 2026-08-22 that the belch binds to a dedicated corner button (ADR 0011), and the second-finger rule was deleted by dispatch 5 rather than left standing here.
