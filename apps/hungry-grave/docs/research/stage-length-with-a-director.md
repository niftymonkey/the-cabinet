...
- `docs/adr/0047-directed-density-inside-authored-beats.md`, `docs/adr/0034-a-power-up-is-an-offer-of-three-and-the-grave-swallows-one.md`, `docs/design/game-concept.md`, `docs/design/tracer-plan.md`
