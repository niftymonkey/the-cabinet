...
**The synthesis, sourced.** Every source that specifies a mechanism uses a velocity over several frames with decay, and **no source anywhere describes knockback as a single-frame position set**. Every source that speaks to it suspends the body's own motion rather than adding the shove on top, and every duration found is short. **Visual accompaniment during a shove, trail, squash, flash or afterimage, is documented by no source for any of these games**, a real gap rather than an oversight. One caution: Megabonk players name enemy knockback as "by far the biggest issue", so a shove too strong or too frequent reads as chaos rather than force. https://steamcommunity.com/app/3405340/discussions/0/600792156684362820/
...
**Touch target floors.** Apple's HIG names 44 by 44 points, Material 48 by 48 dp, WCAG 2.2's 2.5.8 at AA 24 by 24 CSS pixels with five exceptions, and 2.5.5 at AAA 44 by 44. https://www.w3.org/WAI/WCAG22/Understanding/target-size-minimum.html
