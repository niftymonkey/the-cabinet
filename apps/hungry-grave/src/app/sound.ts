 ...
 * are written down. src/boundary.test.ts holds that shut, narrowed to this one
 * file, because a folder rule over src/app would be the wrong instrument and a
 * comment asking nicely would be no instrument at all.
 *
