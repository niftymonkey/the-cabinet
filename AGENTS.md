...
Every production code change, written directly or dispatched to a subagent, follows `docs/agents/feature-flow.md`: how work is planned, spec-tested, verified, and handed off. Read it before planning or writing any code.
